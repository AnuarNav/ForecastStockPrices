...
def get_returns_and_with_predicted(index_given, timeframe_, input_given, recurrence_):
    ...
    """
    absolute_path = f'''/Users/anuarnavarro/Desktop/TFG/GitHub/ForecastStockPrices/Code/Data/{index_given}/Efficient Portfolios/{index_given}_efficient_portfolios_and_returns_{timeframe_}.xlsx'''
