...
input_ = 'input 250'
months = constants.quarter_months
timeframe_name = constants.quarter
dates = constants.quarter_dates
window_size = constants.quarter_window_size
recurrence = 'Manual Recurrence'
TimeSteps = 250  # next few day's Price Prediction is based on last how many past day's prices -INPUT
FutureTimeSteps = 84  # How many days in future you want to predict the prices (it will predict prices
